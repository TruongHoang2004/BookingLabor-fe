...
const tasksList: TaskCardforUser[] = [
  { id: 1, title: "Task 1", description: "Description 1 onaoiwdoiawd  đoaiioădioa dia ưdi", task_status: "Pending", district: "District 1", street: "Street 1", estimated_duration: 2, fee_per_hour: "45", start_date: "2023-01-01", end_date: "2023-01-02", created_at: "2023-01-01", updated_at: "2023-01-01", apply_tasker: [{ id: 1, name: "Nguyen Van A", skill: ["Cleaning", "Moving"], experience: "5 years of cleaning experience" }, { id: 2, name: "Tran Thi B", skill: ["Washing Dishes"], experience: "Expert in painting houses for 7 years" }], chosen_tasker: null },
