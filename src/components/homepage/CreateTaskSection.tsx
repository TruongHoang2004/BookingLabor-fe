      ...
      <div className={'relative w-full h-96 x-sm:h-60 sm:h-72 md:h-80 lg:h-96 2sm:h-56'}>
        ...
        <div className='absolute top-full left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-16'>
          <form action="" className='flex align-center'>
              <input type="text" placeholder="What kind of task do you need help with?" className='focus:outline-none rounded-xl md:text-base x-sm:text-xs 2sm:text-[8px] font-semibold rounded-r-none inline w-4/5 border-green-900 border-2 py-4 px-4'/>
