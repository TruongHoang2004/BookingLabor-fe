            ...
            <div className="w-7/12 m-auto flex 2sm:justify-center 1200:justify-between items-center flex-wrap 2sm:gap-x-10 1200:gap-x-0 2sm:gap-y-10 1200:gap-y-0">
                ...
                <div className="relative h-36">
                    ...
                    <form action="">
                        ...
                        <button type="submit" className={`border py-1 px-4 ${styles.border_color} 2sm:mt-2 x-sm:mt-0 x-sm:absolute x-sm:bottom-3 x-sm:right-4 hover:bg-amber-50 hover:border-2`}>GO</button>
                    </form>
                </div>
            </div>
            <Card  isBlurred className= {`w-8/12 m-auto md:mt-10 2sm:mt-28 1200:py-4`} shadow="md">
               <CardBody>
                    <div className="flex 1200:h-5 items-center justify-center gap-x-8 text-xl 1200:flex-row 2sm:flex-col x-sm:text-lg 2sm:text-sm">
                        ...
                        <Divider orientation="vertical" className={`${styles.border_color} sm:hidđen 1200:block`}/>
                        <Divider className= {`${styles.border_color} sm:block 1200:hidden`}/>
                        <div className="2sm:py-3 1200:py-0">Ha Noi</div>
                        <Divider orientation="vertical" className={`${styles.border_color} sm:hidden 1200:block`}/>
                        <Divider className= {`${styles.border_color} sm:block 1200:hidden`}/>
...
/*
 <div className="flex 1200:h-5 items-center justify-center gap-x-8 gap-y-2 text-xl 1200:flex-row 2sm:flex-col">
                    <div>Vietnam</div>
                    <Divider orientation="vertical" className="bg-amber-950  sm:hidden 1200:block"/>
                    <Divider className="bg-amber-950 sm:block 1200:hidden"/>
                    <div>Ha Noi</div>
                    <Divider orientation="vertical" className="bg-amber-950  sm:hidden 1200:block"/>
                    <Divider className="bg-amber-950 sm:block 1200:hidden"/>
